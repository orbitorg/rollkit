...
func (_m *Store) GetBlockResponses(ctx context.Context, height uint64) (*v1.FinalizeBlockResponse, error) {
	ret := _m.Called(ctx, height)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*v1.FinalizeBlockResponse, error)); ok {
		return rf(ctx, height)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) *v1.FinalizeBlockResponse); ok {
		r0 = rf(ctx, height)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Store) GetExtendedCommit(ctx context.Context, height uint64) (*v1.ExtendedCommitInfo, error) {
	ret := _m.Called(ctx, height)
	...
	var r0 *v1.ExtendedCommitInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*v1.ExtendedCommitInfo, error)); ok {
		return rf(ctx, height)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) *v1.ExtendedCommitInfo); ok {
		r0 = rf(ctx, height)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1.ExtendedCommitInfo)
		}
	}
...
func (_m *Store) SaveBlockResponses(ctx context.Context, height uint64, responses *v1.FinalizeBlockResponse) error {
...
func (_m *Store) SaveExtendedCommit(ctx context.Context, height uint64, commit *v1.ExtendedCommitInfo) error {
